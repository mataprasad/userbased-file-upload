...
<head>
  ...
  <title>User based file uploads | Register</title>
...
<div class="register-box">
  ...
  <a href="<?php HREF('/'); ?>"><b>User based </b>File Uploads</a>
  </div>
  ...
  <div class="register-box-body">
   ...
   <?php } ?>
    ...
    <a href="<?php HREF('/login.php'); ?>" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
